...
function ProductsPage() {
  ...
  // use salesData context to calculate products' total sales revenue, inventory, and total quantity sold in all product sales.
  ...
  return (
    <div className="flex items-center justify-between w-full mt-10">
      ...
      <div className="w-full mt-6">
        ...
        {showForm && (
          <ProductForm
            consolidatedProductData={consolidatedProductData}
